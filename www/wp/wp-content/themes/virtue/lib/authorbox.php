  	...
  	<div class="author-profile vcard">
        ...
        <?php if ( get_the_author_meta( 'facebook' ) ) { ?>
            ...
            <span class="googlepluslink">
				<a href="<?php the_author_meta( 'google' ); ?>" title="<?php _e('Follow', 'virtue'); ?>  <?php the_author_meta( 'display_name' ); ?> <?php _e('on Google Plus', 'virtue');?>"><i class="icon-google-plus2"></i></a>
			</span>
